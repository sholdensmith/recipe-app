...
CREATE TABLE IF NOT EXISTS recipes (
  ...
  is_favorite INTEGER DEFAULT 0, -- 1 if bookmarked, 0 otherwise (stored under legacy name)
  is_fan_favorite INTEGER DEFAULT 0, -- 1 if marked a fan favorite, 0 otherwise
