          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`${recipe.is_favorite ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-gray-200 hover:bg-gray-300'} text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 touch-manipulation min-h-[44px]`}
                title={recipe.is_favorite ? 'Remove from favorites' : 'Add to favorites'}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 pointer-events-none" fill={recipe.is_favorite ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
